                                                            ...
                                                            <div class="btn-group">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('doctor.medicalRecord.edit', $medicalRecord->id) }}"
                                                                        style="size: 20px;">Edit</a>

                                                                        <a class="dropdown-item"
                                                                        href="{{ route('doctor.inspection.medicalRecord.index', $medicalRecord->id) }}"
                                                                        style="size: 20px;">Inspections</a>
                                                                    <form
                                                                        action="{{ route('doctor.medicalRecord.soft.delete', $medicalRecord->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('delete')
