...
<head>
    ...
    <title>Medical Record Archive Table</title>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4>Medical Record Archive Table</h4>
                                </div>
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                        ...
                                                                        <form
                                                                        action="{{ route('doctor.medicalRecord.restore', $medicalRecord->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                    ...
                                                                    <form
                                                                        action="{{ route('doctor.medicalRecord.force.delete', $medicalRecord->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('delete')
                                                                        <button class="dropdown-item" type="submit"
