...
<head>
    ...
    <title>Laboratories Table</title>
                                                            ...
                                                            <div class="btn-group">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('admin.laboratory.edit', $laboratory->id) }}"
                                                                        style="size: 20px;">Edit</a>
                                                                    <form
                                                                        action="{{ route('admin.laboratory.soft.delete', $laboratory->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('delete')
