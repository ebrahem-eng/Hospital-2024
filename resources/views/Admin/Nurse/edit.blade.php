                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                ...
                                                <select class="form-control select2" name="gender" required>
                                                    <option value="1" {{ $nurse->gender === 1 ? 'selected' : '' }}>
                                                        Male
                                                    </option>
                                                    <option value="0" {{ $nurse->gender === 0 ? 'selected' : '' }}>
                                                        Female
                                                    </option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-3">
                                                ...
                                                <select class="form-control select2" name="status" required>
                                                    <option value="1" {{ $nurse->status === 1 ? 'selected' : '' }}>
                                                        Active
                                                    </option>
                                                    <option value="0" {{ $nurse->status === 0 ? 'selected' : '' }}>
                                                        Not
                                                        Active</option>
                                                </select>
                                            </div>
