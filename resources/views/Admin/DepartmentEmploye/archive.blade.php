...
<head>
    ...
    <title>Department Employe Archive Table</title>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4>Department Employe Archive Table</h4>
                                </div>
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <form
                                                                        action="{{ route('admin.departmentEmploye.restore', $departmentEmploye->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                    ...
                                                                    <form
                                                                        action="{{ route('admin.departmentEmploye.force.delete', $departmentEmploye->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('delete')
