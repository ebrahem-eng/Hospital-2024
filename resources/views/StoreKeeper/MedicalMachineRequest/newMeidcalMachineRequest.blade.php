                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <form action="{{ route('storeKeeper.medicalMachineRequest.new.accept', $medicalMachineRequest->id) }}" method="POST">
                                                                    @csrf
                                                                    @method('put')
                                                                    <button class="dropdown-item" type="submit" style="font-size: 12px; padding: 5px 10px;">Accept And Send To Admin</button>
                                                                </form>
                                                                <form action="{{ route('storeKeeper.medicalMachineRequest.new.reject', $medicalMachineRequest->id) }}" method="POST">
                                                                    @csrf
                                                                    @method('put')
